...
custom_stopwords <-
  c("archaeological", "data", "sites",
    ...
    "stephanie", "vanderbilt", "donna", "tierra",
    "ceibal", "dinaa", "agenda", "centro", "guadalupe",
    "jeremy", "islamic", "justin", "want", "armenia",
    "ashley", "natalie", "matt", "danielle", "maria",
    "zhang", "xultun", "paisaje")
